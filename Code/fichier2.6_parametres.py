# -*- coding: utf-8 -*-
"""
Created on Wed Mar 31 21:50:29 2021
...
df_new = df[['id', 'referenceyear', 'tot_assets', 'capital', 'on_time_deposits',
...
capital_ratio_3 = (df_data['paidincapital'])/df_data['tot_assets']
df_data['capital_ratio'] = capital_ratio_3
...
securities_1 = df_data['tot_credit']/df_data['tot_assets']
df_data['securities'] = securities_1
...
Test =  np.array([df_data['referenceyear'][resultat:fin],
                      ...
                      df_data['securities'][resultat:fin]])
...
plt.xlabel('Resultt of the equations')
