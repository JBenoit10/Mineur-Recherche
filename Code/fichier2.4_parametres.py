# -*- coding: utf-8 -*-
"""
Created on Wed Mar 31 19:50:34 2021
...
df_new = df[['id', 'referenceyear', 'tot_assets', 'capital', 'capital_surplus',
             ...
             'securities', 'on_time_deposits','on_demand_deposits']]
...
securities = df_data['securities']/df_data['tot_assets']
df_data['securities'] = securities
...
plt.scatter(Training[0], Training[1], label='Deposits Risks')
plt.scatter(Training[0], Training[2], label='Securities')
plt.legend()
